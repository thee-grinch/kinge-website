...
exports.makeAdmin = exports.onOrderStatusChange = exports.mpesaCallback = exports.createOrder = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const daraja_1 = require("./daraja");
...
exports.createOrder = functions.https.onCall(async (data, context) => {
    ...
    for (const item of items) {
        ...
        if ((productData === null || productData === void 0 ? void 0 : productData.stock) < item.quantity) {
            throw new functions.https.HttpsError('failed-precondition', `Insufficient stock for product ${productData === null || productData === void 0 ? void 0 : productData.name}`);
        }
    ...
    if (paymentMethod === 'MPESA') {
        ...
        try {
            await (0, daraja_1.lipaNaMpesa)(phone, total, orderRef.id);
        }
        catch (e) {
...
exports.makeAdmin = functions.https.onCall(async (data, context) => {
    ...
    if (((_a = requester.customClaims) === null || _a === void 0 ? void 0 : _a.role) !== 'admin') {
